...
define unicorn::app (
  Stdlib::Absolutepath $approot,
  Stdlib::Absolutepath $pidfile,
  Stdlib::Absolutepath $socket,
  Array $listens                              = [],
  Boolean $preload_app                        = false,
  Hash $extra_settings                        = {},
  Integer $init_time                          = 15,
  Integer $workers                            = $facts['processors']['count'],
  Stdlib::Absolutepath $logdir                = "${approot}/log",
  String $backlog                             = '2048',
  String[1] $config_template                  = 'unicorn/config_unicorn.config.rb.erb',
  String[1] $group                            = 'root',
  String[1] $rack_env                         = 'production',
  String[1] $source                           = 'system',
  String[1] $user                             = 'root',
  Optional[Stdlib::Absolutepath] $config_file = undef,
  Optional[String[1]] $initscript             = undef,
